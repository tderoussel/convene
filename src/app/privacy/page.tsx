      ...
      <div className="max-w-2xl mx-auto px-6 py-14">
        ...
        <div className="space-y-6 text-sm text-text-secondary leading-relaxed">
          <section>
            ...
            <p>When you apply to or use Alyned, we collect information you provide directly, including your name, email address, LinkedIn profile URL, professional background, and any other information you choose to share.</p>
          </section>
          <section>
            <h2 className="text-sm font-semibold text-text-primary mb-2">2. How We Use Your Information</h2>
            <p>We use your information to operate and improve Alyned, including reviewing applications, facilitating connections, calculating reputation scores, and communicating about your account.</p>
          </section>
          <section>
          ...
          <section>
            ...
            <p>You may access, update, or delete your personal information through account settings. Contact us at privacy@alyned.app for data requests.</p>
          </section>
          <section>
            <h2 className="text-sm font-semibold text-text-primary mb-2">6. Contact</h2>
            <p>Questions? Email <a href="mailto:privacy@alyned.app" className="text-primary hover:text-primary-hover transition-colors">privacy@alyned.app</a>.</p>
          </section>
        </div>
      </div>
    </div>
