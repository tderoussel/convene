...
const FROM_EMAIL = "Convene <noreply@convene.app>";
    ...
    html: `
      <div style="font-family: Inter, system-ui, sans-serif; max-width: 480px; margin: 0 auto; padding: 40px 24px; color: #fafafa; background: #09090B;">
        ...
        <p style="font-size: 14px; line-height: 1.6; color: #a1a1aa; margin: 0 0 24px;">
          Your application to Convene has been accepted. You now have access to our community of founders, builders, and investors.
        </p>
        <a href="${process.env.NEXT_PUBLIC_SITE_URL ?? "https://convene.app"}/dashboard" style="display: inline-block; padding: 10px 24px; background: #DC2626; color: white; text-decoration: none; border-radius: 6px; font-size: 14px; font-weight: 500;">
          Enter Convene
        </a>
        <p style="font-size: 12px; color: #71717a; margin-top: 32px;">
          If you didn't apply to Convene, you can ignore this email.
        </p>
      </div>
    `,
  };
...
export function applicationReceivedEmail(name: string) {
  return {
    subject: "Application received — Convene",
    html: `
      <div style="font-family: Inter, system-ui, sans-serif; max-width: 480px; margin: 0 auto; padding: 40px 24px; color: #fafafa; background: #09090B;">
        <div style="margin-bottom: 32px;">
          <div style="width: 32px; height: 32px; background: #DC2626; border-radius: 7px; display: inline-flex; align-items: center; justify-content: center;">
        ...
        <p style="font-size: 14px; line-height: 1.6; color: #a1a1aa; margin: 0 0 16px;">
          We've received your application to Convene. Our team reviews every application personally — you'll hear back within 48 hours.
        </p>
        ...
        <p style="font-size: 12px; color: #71717a; margin-top: 32px;">
          Convene — Where ambitious builders connect.
        </p>
      </div>
    `,
  };
...
export function tierUpgradeEmail(name: string, newTier: string) {
  return {
    subject: `You've reached ${newTier} tier — Convene`,
    html: `
      <div style="font-family: Inter, system-ui, sans-serif; max-width: 480px; margin: 0 auto; padding: 40px 24px; color: #fafafa; background: #09090B;">
        <div style="margin-bottom: 32px;">
          <div style="width: 32px; height: 32px; background: #DC2626; border-radius: 7px; display: inline-flex; align-items: center; justify-content: center;">
